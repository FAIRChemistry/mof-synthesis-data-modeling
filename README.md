...
---
## Features
- Two example datasets of MOF synthesis in different formats (handwritten CSV, Sciformation ELN export)
- Formatting synthesis and characterization data from these formats as well as Chemotion ELN export into a well-defined and interoperable structure with the data models
