...
class Experiment:
    ...
    def __init__(self,
                 ...
                 the_3__solvent_amount: int,
                 the_3__solvent_unit: str,
                 the_4__modulator: Union[bool,
                                         str],
                 the_4__modulator_amount: Union[int,
                                                str],
                 the_4__modulator_unit: str,
                 the_5__sonicator_time: float,
                 the_5__sonicator_time_unit: str,
    ...
    def from_dict(obj: Any) -> 'Experiment':
        ...
        the_1__metal_salt_mass_unit = from_str(
            obj.get("1_metal_salt_mass_unit"))
        ...
        the_4__modulator = from_union(
            [from_bool, from_str], obj.get("4_modulator"))
        the_4__modulator_amount = from_union(
            [from_int, from_str], obj.get("4_modulator_amount"))
        ...
        the_8__activation_temperature = from_int(
            obj.get("8_activation_temperature"))
        the_8__activation_temperature_unit = from_str(
            obj.get("8_activation_temperature_unit"))
        ...
        return Experiment(
            the_0__date,
            the_0__vial_no,
            the_1__metal_salt_mass,
            the_1__metal_salt_mass_unit,
            the_1__metal_salt_name,
            the_2__linker_mass,
            the_2__linker_mass_unit,
            the_2__linker_name,
            the_3__solvent,
            the_3__solvent_amount,
            the_3__solvent_unit,
            the_4__modulator,
            the_4__modulator_amount,
            the_4__modulator_unit,
            the_5__sonicator_time,
            the_5__sonicator_time_unit,
            the_6__place,
            the_6__reaction_time,
            the_6__reaction_time_unit,
            the_6__reaction_vessel,
            the_6__temperature,
            the_6__temperature_unit,
            the_7__washing_solids,
            the_8__activation_temperature,
            the_8__activation_temperature_unit,
            the_8__drying_solids,
            the_8__drying_solids_time,
            the_8__drying_time_unit,
            the_9__mof,
            the_9__phase_purity)
    ...
    def to_dict(self) -> dict:
        ...
        result["1_metal_salt_mass_unit"] = from_str(
            self.the_1__metal_salt_mass_unit)
        ...
        result["4_modulator"] = from_union(
            [from_bool, from_str], self.the_4__modulator)
        result["4_modulator_amount"] = from_union(
            [from_int, from_str], self.the_4__modulator_amount)
        result["4_modulator_unit"] = from_str(self.the_4__modulator_unit)
        result["5_sonicator_time"] = to_float(self.the_5__sonicator_time)
        result["5_sonicator_time_unit"] = from_str(
            self.the_5__sonicator_time_unit)
        result["6_place"] = from_str(self.the_6__place)
        result["6_reaction_time"] = from_int(self.the_6__reaction_time)
        result["6_reaction_time_unit"] = from_str(
            self.the_6__reaction_time_unit)
        ...
        result["8_activation_temperature"] = from_int(
            self.the_8__activation_temperature)
        result["8_activation_temperature_unit"] = from_str(
            self.the_8__activation_temperature_unit)
        result["8_drying_solids"] = from_str(self.the_8__drying_solids)
        result["8_drying_solids_time"] = from_int(
            self.the_8__drying_solids_time)
...
class Mil:
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["esenmof"] = from_list(
            lambda x: to_class(Experiment, x), self.esenmof)
        return result
