...
class Mocof1ParamValue:
    acid_amount_umol: float
    acid_name: str
    acid_p_ka_dmso: float
    ...
    def __init__(self, acid_amount_umol: float, acid_name: str, acid_p_ka_dmso: float, activation_under_vacuum: bool, activation_with_sc_co2: bool, aldehyde_monomer_amount_umol: float, aldehyde_monomer_structure: str, aminoporphyrin_monomer_amount_umol: float, aminoporphyrin_monomer_type: str, degassing: bool, duration_h: float, me_oh_in_sc_co2_activation: bool, other_additives: Optional[str], solvent_1__name: str, solvent_1__volume_u_l: float, solvent_2__name: Optional[str], solvent_2__volume_u_l: Optional[float], temperature_c: float, vessel: str, water_amount_umol: float, workup_with_na_cl: bool) -> None:
        self.acid_amount_umol = acid_amount_umol
        self.acid_name = acid_name
        self.acid_p_ka_dmso = acid_p_ka_dmso
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'Mocof1ParamValue':
        assert isinstance(obj, dict)
        acid_amount_umol = from_float(obj.get("acid_amount_umol"))
        acid_name = from_str(obj.get("acid_name"))
        acid_p_ka_dmso = from_float(obj.get("acid_pKa_DMSO"))
        ...
        other_additives = from_union([from_str, from_none], obj.get("other_additives"))
        solvent_1__name = from_str(obj.get("solvent_1_name"))
        solvent_1__volume_u_l = from_float(obj.get("solvent_1_volume_uL"))
        solvent_2__name = from_union([from_str, from_none], obj.get("solvent_2_name"))
        solvent_2__volume_u_l = from_union([from_float, from_none], obj.get("solvent_2_volume_uL"))
        ...
        return Mocof1ParamValue(acid_amount_umol, acid_name, acid_p_ka_dmso, activation_under_vacuum, activation_with_sc_co2, aldehyde_monomer_amount_umol, aldehyde_monomer_structure, aminoporphyrin_monomer_amount_umol, aminoporphyrin_monomer_type, degassing, duration_h, me_oh_in_sc_co2_activation, other_additives, solvent_1__name, solvent_1__volume_u_l, solvent_2__name, solvent_2__volume_u_l, temperature_c, vessel, water_amount_umol, workup_with_na_cl)

    def to_dict(self) -> dict:
        result: dict = {}
        result["acid_amount_umol"] = to_float(self.acid_amount_umol)
        result["acid_name"] = from_str(self.acid_name)
        result["acid_pKa_DMSO"] = to_float(self.acid_p_ka_dmso)
        ...
        if self.other_additives is not None:
            result["other_additives"] = from_union([from_str, from_none], self.other_additives)
        result["solvent_1_name"] = from_str(self.solvent_1__name)
        result["solvent_1_volume_uL"] = to_float(self.solvent_1__volume_u_l)
        if self.solvent_2__name is not None:
            result["solvent_2_name"] = from_union([from_str, from_none], self.solvent_2__name)
        if self.solvent_2__volume_u_l is not None:
            result["solvent_2_volume_uL"] = from_union([to_float, from_none], self.solvent_2__volume_u_l)
...
def mocof1_param_from_dict(s: Any) -> Dict[str, Mocof1ParamValue]:
    return from_dict(Mocof1ParamValue.from_dict, s)


def mocof1_param_to_dict(x: Dict[str, Mocof1ParamValue]) -> Any:
    return from_dict(lambda x: to_class(Mocof1ParamValue, x), x)
