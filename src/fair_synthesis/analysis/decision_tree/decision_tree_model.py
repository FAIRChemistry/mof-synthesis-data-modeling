from fair_synthesis.analysis.decision_tree.range_decision_tree import RangeDecisionTreeClassifier
...
def create_model(
    ...
    if task_is_classification:
        ...
        if extra_tree:
            ...
            model = Pipeline(
                [("preprocess", preprocess), ("regressor",
                                              DecisionTreeRegressor(random_state=42, max_depth=max_depth))]
            )
    return model
